...
ActiveRecord::Schema.define(version: 2022_09_06_191753) do
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "user_id"
    t.bigint "top_answer_id"
    t.index ["top_answer_id"], name: "index_questions_on_top_answer_id"
  ...
  add_foreign_key "questions", "answers", column: "top_answer_id"
